...
export default function GenerateCapitalReportMonthly({ auth }) {
  // Mock transactions for frontend demonstration
  const [transactions, setTransactions] = useState([
    { id: 1, created_at: "2025-11-01 08:30 AM", amount: 1500 },
    { id: 2, created_at: "2025-11-05 10:00 AM", amount: 2500 },
    { id: 3, created_at: "2025-11-12 01:15 PM", amount: 3200 },
  ]);

  const handleGenerateReport = () => {
    console.log("Generating monthly capital report...");
    alert("Monthly capital report generated!");
  };
