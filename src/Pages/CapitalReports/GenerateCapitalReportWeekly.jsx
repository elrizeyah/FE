...
export default function GenerateSalesReportCustom({ user }) {
  const [transactions, setTransactions] = useState([
    ...
    { id: 2, date: "2025-01-14", user: "Admin", action: "Initial Capital", amount: 2800 }, 
    { id: 3, date: "2025-01-21", user: "Admin", action: "Initial Capital", amount: 3200 },
  ]);
  ...
  // Calculate the start and end of the week based on a date
