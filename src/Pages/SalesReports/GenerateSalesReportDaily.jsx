...
export default function GenerateSalesReportDaily({ user }) {
  ...
  const [transactions, setTransactions] = useState([
    { id: 1, created_at: "2025-11-19 08:00 AM", amount: 1500 },
    { id: 2, created_at: "2025-11-19 10:30 AM", amount: 2500 },
    { id: 3, created_at: "2025-11-19 01:15 PM", amount: 3200 },
  ]);

  const handleGenerateReport = () => {
    // Demo action: you can replace this with real report logic
    console.log("Generating daily sales report...");
    alert("Daily sales report generated!");
  };
