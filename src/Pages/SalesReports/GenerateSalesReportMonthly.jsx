...
export default function GenerateSalesReportMonthly({ user }) {
  const [transactions, setTransactions] = useState([
    ...
    { id: 2, created_at: "2025-02-01", user: "Admin", action: "Sale", amount: 2800 },
    { id: 3, created_at: "2025-03-01", user: "Admin", action: "Sale", amount: 3200 },
  ]);
