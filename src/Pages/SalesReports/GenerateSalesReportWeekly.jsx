...
export default function GenerateSalesReportWeekly({ auth }) {
  // Mock transactions for frontend demonstration
  const [transactions, setTransactions] = useState([
    { id: 1, created_at: "2025-11-12 08:30 AM", amount: 1800 },
    { id: 2, created_at: "2025-11-13 10:00 AM", amount: 2200 },
    { id: 3, created_at: "2025-11-14 01:15 PM", amount: 3100 },
  ]);

  const handleGenerateReport = () => {
    console.log("Generating weekly sales report...");
    alert("Weekly sales report generated!");
  };
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "center" }}>
            ...
            <tbody>
              {transactions.length ? (
                ...
                <tr>
                  <td colSpan="3" style={{ textAlign: "center", padding: "1rem", color: "#6b6b6b" }}>
